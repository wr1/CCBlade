...
CCBlite is primarily developed with the support of the U.S. Department of Energy and is part of the [WETO Software Stack](https://nrel.github.io/WETOStack). For more information and other integrated modeling software, see:
...
CCBlite execution requires: `numpy`, `scipy`, `openmdao`
CCBlite installation requires: `meson`, `ninja`, `gfortran`

## Installation

CCBlite is available as a [WISDEM](https://github.com/WISDEM/WISDEM) module and WISDEM is both pip-installable and conda-installable. For building CCBlite from source as a standalone library, first make sure that you have the necessary prerequisites installed.  After cloning the repository, do:
