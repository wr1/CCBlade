...
numpydoc_show_class_members = (
    False  # don't let numpydoc generate autosummary b/c it messes up toctree
)
...
latex_documents = [
    ("index", codeName + ".tex", codeName + " Documentation", authorName, "manual"),
]
...
man_pages = [("index", codeName, codeName + " Documentation", [authorName], 1)]
